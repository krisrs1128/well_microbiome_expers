...
clusters (especially Erysipelos). Cluster 4 seems to have more Ruminoccoceae and less Bacteroidaceae,
while in Cluster 1 that pattern is reversed. Cluster 1 seems somewhat more
diverse, though it's a little less clear, since it also has narrower boxplots
(because most samples have some contribution to Cluster 1, improving the
posterior estimates).
