...
\documentclass[utf8]{frontiersFPHY} % for Science, Engineering and Humanities and Social Sciences articles
...
\def\firstAuthorLast{Sankaran {et~al.}} %use et al only if is more than 1 author
\def\Authors{Kris Sankaran\,$^{1}$ and Susan P. Holmes\,$^{2}$}

\def\Address{$^{1}$Montreal Institute for Learning Algorithms, Montreal, Québec, Canada\\
$^{2}$Department of Statistics, Stanford University, Stanford, California, United States}
\def\corrAuthor{Kris Sankaran}
\def\corrEmail{sankarak@iro.umontreal.ca}
...
\title{Multitable Methods for Microbiome Data Integration}
...
\tiny
 \keyFont{ \section{Keywords:} microbiome, data integration, multiomics, dimensionality reduction, heterogeneity} %All article types: you may provide up to 8 keywords; at least 5 are mandatory.
\end{abstract}
...
\begin{figure}
  \centering \includegraphics[width=\textwidth]{figure/pca/loadings}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{figure/pca/scores_android_fm}
...
\begin{figure}
  \centering \includegraphics[width=\textwidth]{figure/CCA/loadings}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{figure/cca/scores_android_fm}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{figure/spls/android_fm_species}
...
\begin{figure}
  \centering \includegraphics[width=\textwidth]{figure/pmd/loadings}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{figure/pmd/scores_android_fm}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{figure/pmd/android_fm_species}
...
\section*{Funding}
KS was supported by a Stanford University Weiland fellowship and the National
...
We thank the WELL China study team for the sharing data appearing in this study.

An earlier version of this work first appeared in KS's PhD thesis
\citep{sankaran2018thesis}.
...
The original data behind this study are not publicly available, due to privacy
considerations.

But we should provide a version of resampled or simulated data....just so people
can rerun our scripts.
