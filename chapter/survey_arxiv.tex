...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{pca_proj_plot_1}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{pca_var_plot}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{pca_loadings}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{pca_scores_android_fm}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{pca_scores_rl_ratio}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{cca_loadings}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{cca_scores_linked}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{cca_scores_android_fm}
  \caption{The scores resulting from CCA applied to the combined body
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{cca_scores_rl_ratio}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{coia_scores_android_fm}
...
\begin{figure}
  \centering
  \includegraphics[width=0.7\textwidth]{pca_iv_geometry}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{pca_iv_loadings}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{spls_coef_heatmap}
  \caption{
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{spls_android_fm_species}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{spls_gynoid_fm_species}
  \caption{
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{pmd_illustration_sequence}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{pmd_loadings}
  \caption{
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{pmd_scores_android_fm}
  \caption{
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{pmd_android_fm_species}
  \caption{
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{lda_cca_within_loadings_seq_boxplots}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{lda_cca_within_loadings_body_comp_boxplots}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{lda_cca_between_loadings_seq_boxplots}
...
\begin{figure}
  \centering
  \includegraphics[width=0.95\textwidth]{lda_cca_between_loadings_body_comp_boxplots}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{graph_lasso_graph}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{graph_lasso_coef_heatmap}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{graph_lasso_multitask_lasso_hm}
...
\begin{figure}
  \includegraphics[width=0.7\textwidth]{pca_proj_plot_2}
...
\begin{figure}
  \includegraphics[width=0.7\textwidth]{pca_proj_plot_3}
...
\begin{figure}
  \centering \includegraphics[width=\textwidth]{coia_loadings}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{coia_scores_rl_ratio}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{pca_iv_scores_android_fm}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{pca_iv_scores_rl_ratio}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{pmd_illustration_scatter}
...
\end{figure}
 ...
 \begin{figure}
   \centering
   \includegraphics[width=0.9\textwidth]{lda_cca_unshared_scores_fm_posterior}
 ...
 \begin{figure}
   \centering
   \includegraphics[width=0.9\textwidth]{lda_cca_shared_scores_fm_posterior}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{graph_lasso_multitask_lasso_hm_lambdas}
