...
Figure \ref{fig:coia_scores_loadings}, and they are similar to those in Figure
\ref{fig:cca_scores_loadings}. However, the associated scores are quite
different than those found using CCA, consider Figure
\ref{fig:fig:coia_scores_weight}, which shades samples by weight, or
...
concatenated-PCA result of Figure \ref{fig:pca_scores_weight}. It is not
...
\begin{figure}[ht]
  ...
  \caption{\label{fig:coia_scores_rl_ratio} }
\end{figure}
