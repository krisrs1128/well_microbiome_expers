...
distint from those used to analyze a single measurement type at a time.

- Abstract Goals:
  + simulataneous study of multiple measurement types for a single sample
  + different ``sensors'' giving complementary views of the same phenomena
  + value in relating complementary views -- better to not just lump everything
  together
  + provide reductions of the data that describe covariation between sets of
  features (not just features and response)
  + I need some sort of succinct analogy
- Motivating application
  + WELL study: effort to study...
  + Many sources related to different aspects of health
  + Can be used to study associations between these different aspects
  + Microbiome and body composition?
