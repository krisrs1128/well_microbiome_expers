...
available online at \url{https://github.com/krisrs1128/well_microbiome_expers}.
...
is focused on the relationships between various indicators of wellness \citep{wellchina}.
In this study, 1969 individuals\footnote{Though sampling is
...
\end{figure}
 ...
 \begin{figure}[ht]
   ...
   \caption{Posterior samples of scores $\xi^{Y}_i$ associated with the body
     ...
     33 body composition variables, rather than counts for all $\sim 600$
     species.
