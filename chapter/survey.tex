...
\begin{figure}[ht]
  ...
  \caption{\label{fig:pca_iv_loadings} }
\end{figure}
...
Section \ref{sec:pta_alpha_derivation}), and leads to the compromise table,
\begin{align*}
...
\begin{figure}[ht]
  ...
  \caption{\label{fig:pca_iv_scores_total_fm} }
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{figure/pca_iv/scores_rl_ratio}
  \caption{\label{fig:pca_iv_scores_rl_ratio} }
\end{figure}
...
\ref{subsec:pta_alpha_derivation}
