...
\begin{figure}
  ...
  \caption{The CCA analog of the PCA loadings plot in Figure \ref{fig:loadings}.
    ...
    microbial abundance data set. Each point is a species, and text are body
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{figure/coia/scores_android_fm}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{figure/spls/gynoid_fm_species}
  \caption{
...
complicates interpretation of these loadings. If we flip the sign of the second
row of loadings, it appears that the main difference between the first and
second loadings is the rate of decay in frequencies from more to less abundant
species. However, no clear distinction appears between taxa among the first two
loadings. The main characteristic of the third loading is that it differentiates
...
\ref{fig:lda_cca_unshared_scores_fm_posterior}. The second axes reflects similar
...
\ref{fig:lda_cca_shared_scores_fm_posterior}, this variation is not clearly
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{figure/pca_iv/scores_android_fm}
...
\end{figure}
 ...
 \begin{figure}
   \centering
   \includegraphics[width=0.9\textwidth]{figure/lda_cca/unshared_scores_fm_posterior}
 ...
 \begin{figure}
   \centering
   \includegraphics[width=0.9\textwidth]{figure/lda_cca/shared_scores_fm_posterior}
