...
\begin{figure}
  ...
  \caption{The same scores as Figure \ref{fig:scores_total_fm}, but shaded now
...
\begin{figure}
  ...
  \caption{The same scores as Figure \ref{fig:cca_scores_android_fm}, but shaded
    now by the ratio of Ruminococcaceae and Lachnospiraceae
...
\begin{figure}
  ...
  \caption{The normalized scores from each table, displayed
    ...
    \ref{fig:cca_scores_total_fm} from CCA, though the aspect ratio has been
    adjusted according to the relative amount of variance explained by the first
    two CoIA axes.
    \label{fig:coia_scores_total_fm} }
\end{figure}
...
\begin{figure}
  ...
  \caption{
    ...
    than lean, mass along the $y$-axis. \label{fig:spls_total_fm_species}
  }
\end{figure}
