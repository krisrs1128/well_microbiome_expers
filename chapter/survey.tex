...
$L_{1} = L_{2} = 4$ for the number of unshared topics. While the use of
shared ($\xi_{i}^{s}$) and unshared ($\xi_{i}^{x}, \xi_{i}^{y}$) scores gives
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{figure/lda_cca/loadings_body_comp}
  \caption{\label{fig:loadings_body_comp} }
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{figure/lda_cca/loadings_seq}
  \caption{\label{fig:loadings_seq} }
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{figure/lda_cca/shared_scores_1}
  \caption{\label{fig:shared_scores_1} }
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=0.5\textwidth]{figure/lda_cca/shared_loadings_body_comp}
  \caption{\label{fig:shared_loadings_body_comp} }
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{figure/lda_cca/shared_loadings_seq}
  \caption{\label{fig:shared_loadings_seq} }
\end{figure}

Supplementary Figures \ref{fig:lda_cca_shared_scores_2} through
\ref{fig:lda_cca_unshared_scores_4} layer alternative supplementary variables on
both the shared scores and the table-specific scores.
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{figure/lda_cca/shared_scores_2}
  \caption{\label{fig:lda_cca_shared_scores_2} }
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{figure/lda_cca/shared_scores_3}
  \caption{\label{fig:lda_cca_shared_scores_3} }
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{figure/lda_cca/shared_scores_4}
  \caption{\label{fig:lda_cca_shared_scores_4} }
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{figure/lda_cca/unshared_scores_1}
  \caption{\label{fig:lda_cca_unshared_scores_1} }
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{figure/lda_cca/unshared_scores_2}
  \caption{\label{fig:lda_cca_unshared_scores_2} }
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{figure/lda_cca/unshared_scores_3}
  \caption{\label{fig:lda_cca_unshared_scores_3} }
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{figure/lda_cca/unshared_scores_4}
