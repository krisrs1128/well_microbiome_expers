...
\usepackage{natbib, amssymb, amsmath, amsfonts,graphicx, hyperref}
\input{preamble.tex}
...
\def\Address{$^{1}$Montreal Institute for Learning Algorithms, Montreal, Quebec, Canada\\
$^{2}$Department of Statistics, Stanford University, Stanford, California, United States}
\def\corrAuthor{Kris Sankaran}
\def\corrEmail{sankaran.kris@gmail.com}

\begin{document}
\title[Multitable Methods]{Multitable Methods and Microbiome Data Integration}
